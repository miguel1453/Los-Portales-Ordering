...
struct CakeService {
    ...
    func postCake(customerName: String, customerNumber: String, cakePickupDate: String, cakeColor: String, cakeSize: String, cakeMessage: String, cakeImage: String, cakeComments: String, completion: @escaping(Bool) -> Void) {
